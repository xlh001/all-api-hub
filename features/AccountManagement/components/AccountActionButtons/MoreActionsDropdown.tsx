...
export const MoreActionsDropdown: React.FC<MoreActionsDropdownProps> = ({
  ...
  return (
    <Menu as="div" className="relative">
      ...
      <MenuItems
        anchor="bottom end"
        className="z-50 w-24 bg-white dark:bg-dark-bg-secondary rounded-lg shadow-lg border border-gray-200 dark:border-dark-bg-tertiary py-1 focus:outline-none [--anchor-gap:4px] [--anchor-padding:8px]">
