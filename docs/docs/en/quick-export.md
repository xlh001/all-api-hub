...
| -------------------------- | -------------------- | --------------------------------------------------------------------------- |
| Priority action            | Self-hosted site     | Calls the configured backend management API to create a channel or provider   |
...
3. **Target credentials**:
   ...
   - Configure the management address and credentials for Claude Code Router, and the self-hosted site before importing.
...
3. Follow the target dialog to copy or download the configuration, launch an application, or import through a management API. For batch self-hosted-site operations, select multiple keys and open the preview from the page's batch actions.
