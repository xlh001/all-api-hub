...
- **QQ / 360 and other Chromium browsers**: see the [manual installation guide](../other-browser-install.md).
...
- **Fallback option**: if the store build is unavailable, download the Stable package from [GitHub Releases](https://github.com/qixing-jk/all-api-hub/releases/latest). Manually installed builds do not update automatically.
