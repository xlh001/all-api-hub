...
- **モデル同期およびチャネル管理との連携**
  - 通常、**セルフホスト型サイトモデル同期** および **セルフホスト型サイト管理** と組み合わせて使用されます。
...
- プラグインで **New API 統合設定** が構成済みであること。
  - **管理者 URL**、**管理者トークン `Admin Token`**、**ユーザー ID** を入力済みであること。
...
- **New API 設定の欠落を通知される**
  - **基本設定 → New API 統合設定** で、管理者 URL、管理者トークン `Admin Token`、ユーザー ID を入力して保存してください。
- **機能が無効になっていると通知される**
