...
export function KeyDisplay({
  ...
  return (
    <div className="flex items-center gap-2 min-w-0">
      ...
      <code className="bg-gray-100 dark:bg-dark-bg-tertiary px-1.5 sm:px-2 py-0.5 sm:py-1 rounded font-mono text-[10px] sm:text-xs text-gray-800 dark:text-dark-text-secondary truncate flex-1 min-w-0">
