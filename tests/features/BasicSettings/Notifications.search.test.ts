...
describe("notifications settings search definitions", () => {
  ...
  it("registers notification controls on the notifications tab", () => {
    ...
    expect(
      ...
      SETTINGS_ANCHORS.TASK_NOTIFICATIONS_TELEGRAM_CHAT_ID,
      SETTINGS_ANCHORS.TASK_NOTIFICATIONS_FEISHU_WEBHOOK_KEY,
      SETTINGS_ANCHORS.TASK_NOTIFICATIONS_DINGTALK_WEBHOOK_KEY,
      SETTINGS_ANCHORS.TASK_NOTIFICATIONS_DINGTALK_SECRET,
      SETTINGS_ANCHORS.TASK_NOTIFICATIONS_WECOM_WEBHOOK_KEY,
      SETTINGS_ANCHORS.TASK_NOTIFICATIONS_NTFY_TOPIC_URL,
