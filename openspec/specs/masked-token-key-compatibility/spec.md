...
## Purpose
Define how token-based workflows remain functional when supported backends mask token keys in inventory responses and require explicit full-key resolution for secret-dependent actions.
