# model-key-compatibility Specification

## Purpose
Allow users to check whether a selected model has any usable API key/token for the owning account, and guide them to create a compatible token when none exists.
