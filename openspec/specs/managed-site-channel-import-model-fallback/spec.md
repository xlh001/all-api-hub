# managed-site-channel-import-model-fallback Specification

## Purpose
Define how managed-site channel import behaves when the selected key's live upstream model-list cannot be loaded during dialog preparation.
