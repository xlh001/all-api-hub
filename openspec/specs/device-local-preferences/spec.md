...
## Purpose
Device-local preference handling during WebDAV sync keeps per-device refresh settings out of the shared preference payload while still allowing explicit full backup restores to reapply them.
