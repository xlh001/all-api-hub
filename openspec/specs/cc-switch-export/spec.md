# cc-switch-export Specification

## Purpose
Define requirements for exporting an All API Hub account token or API credential profile into CC Switch, including supported target apps, deeplink export behavior, external-import limitations for OpenCode/OpenClaw API formats, and app-specific endpoint defaults.
