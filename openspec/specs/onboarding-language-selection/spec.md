...
## Purpose
Defines the requirements for exposing the shared language selector during first-install onboarding so users can choose and persist their UI language before completing or dismissing optional permission onboarding.
