...
> [!TIP]
> - 大多数用户优先使用正式版 Stable，版本说明更完整，稳定性更高。
> - Nightly 基于 `main` 最新提交自动生成，适合想提前体验新功能、验证修复或协助反馈问题的用户。
> - 商店版本通常会因为审核延迟 1-3 天；GitHub 正式版一般更早，Nightly 则是最快但风险也更高。
>
...
1. 从 GitHub Release 下载附件：
   打开 [最新版本 Release](https://github.com/qixing-jk/all-api-hub/releases/latest)，下载 `all-api-hub-<version>-safari-xcode-bundle.zip`，解压后直接打开其中的 Xcode 工程运行
2. 从源码构建：
...
请下载 `all-api-hub-<version>-safari-xcode-bundle.zip`，不要下载 `all-api-hub-<version>-safari.zip`。解压后直接打开工程即可。
