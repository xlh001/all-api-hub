...
- 🌐 **全平台支持**  
  兼容 Chrome、Edge、Firefox 与移动端 / 手机端浏览器，例如手机 Edge、Firefox for Android、Kiwi 等，适配深色模式。
