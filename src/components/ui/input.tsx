...
const inputVariants = cva(
  "file:text-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-input h-auto w-full min-w-0 rounded-md border bg-transparent px-3 py-density-1 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:min-h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive placeholder:text-faint-foreground text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent",
  {
    variants: {
      variant: {
        default: "",
      ...
      size: {
        default: "min-h-(--density-control)",
        sm: "min-h-(--density-control-sm) px-2 text-xs",
        lg: "min-h-(--density-input-lg) px-4",
      },
    },
    defaultVariants: {
      variant: "default",
