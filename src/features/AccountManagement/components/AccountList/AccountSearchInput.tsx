  ...
  return (
    <div className="relative">
      <Input
        ...
        type="text"
        size="sm"
        className="border-border bg-surface-subtle/70 dark:bg-foreground/5 min-h-(--density-control-lg) shadow-none [@container(min-width:40rem)]:min-h-(--density-control)"
        value={value}
