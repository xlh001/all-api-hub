    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          {isEditMode && <p className="mt-1 text-xs text-gray-500">编辑模式下无法更改账号</p>}
        </div>
        ...
        <div className="space-y-3">
          ...
          {!formData.unlimitedQuota && (
            <div>
              ...
              />
              {errors.quota && <p className="mt-1 text-xs text-red-600">{errors.quota}</p>}
        ...
        <div>
          ...
          />
          {errors.expiredTime && <p className="mt-1 text-xs text-red-600">{errors.expiredTime}</p>}
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          />
          {errors.allowIps && <p className="mt-1 text-xs text-red-600">{errors.allowIps}</p>}
          <p className="mt-1 text-xs text-gray-500">
